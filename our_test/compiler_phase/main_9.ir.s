...
.Lcfi7:
	...
	xorl	%eax, %eax
	callq	printf
	movq	$.Lsystem_string.16, -160(%rbp)
	movl	$.Lfmt_str, %edi
	movl	$.Lsystem_string.16, %esi
	xorl	%eax, %eax
	callq	printf
	movq	$.Lsystem_string.17, -72(%rbp)
	callq	f2
	movq	(%rax), %rbx
	movq	%rax, %rdi
	callq	free
...
.Lsystem_string.15:
	.zero	1
	.size	.Lsystem_string.15, 1

	.type	.Lsystem_string.16,@object # @system_string.16
.Lsystem_string.16:
	.asciz	"hahaha"
	.size	.Lsystem_string.16, 7

	.type	.Lsystem_string.17,@object # @system_string.17
.Lsystem_string.17:
	.zero	1
	.size	.Lsystem_string.17, 1

	.type	.Lsystem_string.18,@object # @system_string.18
.Lsystem_string.18:
	.asciz	"now s is :"
	.size	.Lsystem_string.18, 11
