...
"&sup="+(dv_GetParam(e,"sup")||"")+"&isovv="+t+"&gmnpo="+(dv_GetParam(e,"gmnpo")||"");(d=dv_GetParam(e,"xff"))&&(t+="&xff="+d);(d=dv_GetParam(e,"useragent"))&&(t+="&useragent="+d);t+="&dup="+dv_GetParam(e,"dup");if(void 0!=window._dv_win.$dvbs.CommonData.BrowserId&&void 0!=window._dv_win.$dvbs.CommonData.BrowserVersion&&void 0!=window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent)k=window._dv_win.$dvbs.CommonData.BrowserId,m=window._dv_win.$dvbs.CommonData.BrowserVersion,d=window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent;
else{var p=d?decodeURIComponent(d):navigator.userAgent;k=[{id:4,brRegex:"OPR|Opera",verRegex:"(OPR/|Version/)"},{id:1,brRegex:"MSIE|Trident/7.*rv:11|rv:11.*Trident/7|Edge/",verRegex:"(MSIE |rv:| Edge/)"},{id:2,brRegex:"Firefox",verRegex:"Firefox/"},{id:0,brRegex:"Mozilla.*Android.*AppleWebKit(?!.*Chrome.*)|Linux.*Android.*AppleWebKit.* Version/.*Chrome",verRegex:null},{id:0,brRegex:"AOL/.*AOLBuild/|AOLBuild/.*AOL/|Puffin|Maxthon|Valve|Silk|PLAYSTATION|PlayStation|Nintendo|wOSBrowser",verRegex:null},
{id:3,brRegex:"Chrome",verRegex:"Chrome/"},{id:5,brRegex:"Safari|(OS |OS X )[0-9].*AppleWebKit",verRegex:"Version/"}];d=0;m="";for(h=0;h<k.length;h++)if(null!=p.match(new RegExp(k[h].brRegex))){d=k[h].id;if(null==k[h].verRegex)break;p=p.match(new RegExp(k[h].verRegex+"[0-9]*"));null!=p&&(m=p[0].match(new RegExp(k[h].verRegex)),m=p[0].replace(m[0],""));break}k=h=Q();m=h===d?m:"";window._dv_win.$dvbs.CommonData.BrowserId=k;window._dv_win.$dvbs.CommonData.BrowserVersion=m;window._dv_win.$dvbs.CommonData.BrowserIdFromUserAgent=
...
I);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"91"}};
